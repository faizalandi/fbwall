...
*/
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendDropContainer: function( controlItem ) {
            ...
            wrapper.css({ position: 'absolute', left: "-33000px", top: "-33000px", width:'200px'  });
        ...
        _appendControl: function() {
            ...
            control.css( { display: "inline-block", overflow: "hidden", 'white-space': 'nowrap', width: ((options.width + 7)+'px')} );
